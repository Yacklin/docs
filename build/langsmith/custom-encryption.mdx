...
# The AWS Encryption SDK uses envelope encryption: one KMS API call generates a data key,
...
async def decrypt_json(ctx: EncryptionContext, data: dict) -> dict:
    ...
    for key, value in data.items():
        if key in SENSITIVE_FIELDS and isinstance(value, str):
            ...
            except (BinasciiError, SerializationError, NotSupportedError):
                # Not encrypted (pre-migration data), return as-is
                result[key] = value
        else:
            result[key] = value
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/langsmith/custom-encryption.mdx)
</Callout>
